...
On iOS, the native bridge normalizes seeds outside the signed 32-bit range
before Google's Swift wrapper receives them, preventing an integer-overflow
trap. This makes timestamp-derived JavaScript seeds safe to pass.
